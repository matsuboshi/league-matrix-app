...
func (_mock *MockMatrixRepositoryInterface) GetFileContent(ctx context.Context, filePath string) (*repository.MatrixFileContent, error) {
	...
	var r0 *repository.MatrixFileContent
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (*repository.MatrixFileContent, error)); ok {
		return returnFunc(ctx, filePath)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) *repository.MatrixFileContent); ok {
		r0 = returnFunc(ctx, filePath)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*repository.MatrixFileContent)
		}
	}
...
func (_c *MockMatrixRepositoryInterface_GetFileContent_Call) Return(matrixFileContent *repository.MatrixFileContent, err error) *MockMatrixRepositoryInterface_GetFileContent_Call {
	_c.Call.Return(matrixFileContent, err)
	return _c
}

func (_c *MockMatrixRepositoryInterface_GetFileContent_Call) RunAndReturn(run func(ctx context.Context, filePath string) (*repository.MatrixFileContent, error)) *MockMatrixRepositoryInterface_GetFileContent_Call {
	_c.Call.Return(run)
	return _c
}
